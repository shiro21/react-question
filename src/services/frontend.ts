...
export const javascript = [
    ...
    },
    {
        ...
        arr: `
            바인딩이란 서로 묶어서 연결해 준다는 뜻입니다. 이벤트 바인딩은 발생하는 이벤틍와 그 후에 어떤 일이 벌어질지 알려주는 함수( 콜백함수 )와 묶어서 연결해 준다는 뜻입니다.<br />
    ...
    },
    {
        ...
        arr: `
            화살표 함수는 함수를 간단하게 표현할 수 있는 ES6문법입니다. 이란 함수는 this가 동적으로 바인딩되는 반면 화살표 함수는 바로 상위 스코프의 this와 같습니다. 또한, 화살표 함수는 프로토타입 프로퍼티를 갖고있지 않기 때문에 생성자 함수로 사용이 어렵고, 일반함수에서는 함수가 실행될 때 암묵적으로 arguments변수가 전달되어 사용할 수 있지만, 화살표 함수에서는 arguments변수가 전달되지 않습니다.<br />
    ...
    },
    {
        ...
        arr: `
            ...
            Set<br />
            입력 순서를 유지하지 않으며, 데이터의 중복을 허용하지 않습니다. 데이터에 null입력이 가능하나, 한 번만 저장하고 중복 저장을 허요하지 않습니다. 인덱스가 따로 존재하지 않기 때문에 Iterator를 사용하여 조회합니다.<br />
            추가: List<br />
